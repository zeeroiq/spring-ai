...
@Slf4j
@SpringBootTest
class SummarizingPromptsTests extends BaseTest {
    ...
    private static final String REVIEW_PROMPT = """
            Your task is to generate a short summary for the book from an ecommerce site. The summary will be used for a
    ...
    void testCreateDescriptionFromReview() {
        String response = chat(REVIEW_PROMPT, Map.of("review", REVIEW_1));
    ...
    @Test
    void testCreateDescriptionFromReviews() {
        String res = chat(REVIEW_PROMPT_V2, Map.of("review", REVIEW_1, "review2", REVIEW_2, "review3", REVIEW_3));
        assertNotNull(res);
        log.info("\n{}\n", res);
    }

    String REVIEW_PROMPT_V3 = """
    ...
    @Test
    void testCreateDescriptionFromReviewsV3() {
        String res = chat(REVIEW_PROMPT_V3, Map.of("review", REVIEW_1, "review2", REVIEW_2, "review3", REVIEW_3));
        assertNotNull(res);
        log.info("\n{}\n", res);
    }
